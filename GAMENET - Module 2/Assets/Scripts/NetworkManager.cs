...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    public GameObject joinRoomListPanel;
    ...
    public override void OnJoinedRoom()
    {
        ...
        roomInfoText.text = "RoomName: " + PhotonNetwork.CurrentRoom.Name + " Current Player Count: " +
    ...
    public void ActivatePanel(GameObject panelToBeActivated)
    {
        ...
        joinRoomListPanel.SetActive(panelToBeActivated.Equals(joinRoomListPanel));
